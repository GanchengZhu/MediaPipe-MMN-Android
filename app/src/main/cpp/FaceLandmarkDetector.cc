...
namespace mirror {
    ...
    bool FaceLandmarkDetector::LoadModel(AAssetManager *mgr, const char *model_file) {
...
//        schedule_config.mode =
    ...
    bool FaceLandmarkDetector::Detect(const ImageHead &in, RotateType type,
        ...
        for (auto &object: objects) {
            ...
            std::vector<Point2f> region = getInputRegion(in, type, object.rect, input_h_, input_w_,
                                                         object.angle, 1.5f, 0.0f, 0.0f);
            // clang-format off
            float points_src[] = {
